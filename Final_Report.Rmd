...
3. Find the acceptance probability: $$\alpha(\theta_{new}, \theta_{i-1}) = min[1, r(\theta_{new}, \theta_{i-1})], \ where\ r(\theta_{new}, \theta_{i-1}) = \cfrac{\pi(\theta_{i-1})q(\theta_i|\theta_{i-1})}{\pi(\theta_{i})q(\theta_{i-1}|\theta_{i})}$$
